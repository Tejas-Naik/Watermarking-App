...
TARGET_DIRECTORY = "./images/Watermarked Photos"
...
def open_file():
    ...
    photo_name = askopenfilename(initialdir=SOURCE_DIRECTORY, title="Select A File", filetype=(("jpeg files", "*.jpg"), ("all files", "*.*")))
    if photo_name:
